...
# In this case, Iterative-Deepening Depth-Limited Min-Max with Alpha-Beta Pruning
def algorithm(board_list, color, remaining_time, history):
    ...
    for depth in range(0, max_depth):
        ...
        action_list = min_max(board_list, color, move, score, alpha, beta, start_depth, depth)
...
def min_max(board_list, color, parent, score, alpha, beta, depth, max_depth):
    ...
    for action in action_list:
        ...
        child_move = min_max(new_board, enemy, action, move_score, alpha, beta, depth + 1, max_depth)
